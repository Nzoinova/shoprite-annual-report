...
const kpis: KPI[] = [
  ...
  { value: '3.7', numericValue: 3.7, suffix: 'd', labelEn: 'Avg. Immobilization', labelPt: 'Imobilização Média', detail: 'Median: 2 days' },
  ...
  return (
    <section id="sec-summary" className="py-20 px-6 md:px-15 max-w-6xl mx-auto fade-in">
      ...
      <p className="font-light text-sm text-dark-gray max-w-xl mb-10">
        {lang === 'en'
          ? '345 interventions across 57 vehicles, delivered through our integrated network. A 92% increase in monthly service volume compared to 2024.'
          : '345 intervenções em 57 viaturas, através da nossa rede integrada. Aumento de 92% no volume mensal face a 2024.'}
      </p>
